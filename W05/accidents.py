    ...
    try:
        ...
        with open(filename, "rt") as text_file:
            ...
            if perc_reduc < 0 or perc_reduc > 100:
                print('You have entered a value outside of range.')
                print('Run the program again and enter a value between 1 to 100.')
            else:
                print()
        ...
        # This code will be executed if the user enters
        # an invalid value for the perc_reduc.
        print()
        print(type(val_err).__name__, val_err, sep=": ")
        print("You entered a value that could not be converted into percentage.")
        print("Run the program again and enter a value between 1" \
                " to 100.")       
