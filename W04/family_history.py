...
def print_marriages(marriages_dict, people_dict):
    ...
    for _ in marriages_dict:
        husband_key = marriages_dict[HUSBAND_KEY_INDEX]
        wife_key = marriages_dict[WIFE_KEY_INDEX]
        if husband_key in people_dict and wife_key in people_dict:
            person_details = people_dict[husband_key]
            husband_name = person_details[NAME_INDEX]
            husband_age = marriages_dict[WEDDING_YEAR_INDEX] - person_details[BIRTH_YEAR_INDEX]
            person_details = people_dict[wife_key]
            wife_name = person_details[NAME_INDEX]
            wife_age = marriages_dict[WEDDING_YEAR_INDEX] - person_details[BIRTH_YEAR_INDEX]
            print(husband_name, husband_age, wife_name, wife_age)
        else:
            print('Not Found')
