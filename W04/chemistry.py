...
def main():
    ...
    converted_formula = parse_formula(formula, periodic_table_dict)
    # Call the compute_molar_mass function to compute the
    # molar mass of the molecule from the compound list.
    molecule_molar_mass = compute_molar_mass(converted_formula, periodic_table_dict)
    # Compute the number of moles in the sample.
    number_of_moles = mass / molecule_molar_mass
    # Print the molar mass.
    print(f'{molecule_molar_mass:.5f} grams/mole')
    # Print the number of moles.
    print(f'{number_of_moles:.5f} moles')
    
    # code from milestone 07
    # periodic_table_list = make_periodic_table()
    # for value in periodic_table_list:
    #     name = value[1]
    #     atomic_mass = value[2]
    ...
    print(f'This chemical formula is {formula_name}')
